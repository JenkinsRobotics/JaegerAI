...
(async()=>{
  ...
  if(profileLabel) profileLabel.textContent=(typeof profileDisplayName==='function'?String(profileDisplayName(S.activeProfile||'default')):(S.activeProfile||'default'));
  const titleLabel=$('titlebarProfileLabel');
  if(titleLabel) titleLabel.textContent=(typeof profileDisplayName==='function'?String(profileDisplayName(S.activeProfile||'default')):(S.activeProfile||'default'));
