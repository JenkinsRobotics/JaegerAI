...
def _load() -> tuple[Any | None, Any | None]:
    ...
    if not pj.exists():
        ...
        # path.
        from jaeger_ai.features.personality import Personality
        return layout, Personality(name=layout.root.name)
    try:
        from jaeger_ai.features.personality import load_personality
...
def run_set(args: Any) -> int:
    ...
    try:
        ...
        return 1
    pj = layout.root / "personality.json"
    from jaeger_ai.features.personality import save_personality
