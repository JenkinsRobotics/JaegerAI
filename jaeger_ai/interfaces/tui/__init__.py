...
def run_surface(ctx: Any, spec: Any) -> Any:
    ...
    only dispatches ``event_loop = "qt" | "none"``; JaegerAI's TUI is
    ...
    so JaegerAI keeps owning the TUI loop.
    """
    raise NotImplementedError(
        "JaegerAI TUI surface is launched directly by launch.py; the "
        "format-0.1 chassis sets event_loop = 'none' and returns "
        "after boot, leaving the TUI loop to JaegerAI. This stub exists "
