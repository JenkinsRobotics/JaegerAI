...
from jaeger_ai.core.messages import ChatMessage
from jaeger_ai.interfaces.tui.banner import JAEGER_ASCII, TAGLINE
from jaeger_ai.interfaces.tui.theme import ACCENT  # #3aa0ff — the brand accent
...
class ChatWindow(QWidget):
    ...
    def __init__(self, ctx: Any) -> None:
        ...
        self.setObjectName("JaegerChatWindow")
        self.setWindowTitle(f"JaegerAI — {self._agent_name} · {self._mode}")
        self.resize(760, 660)
        self._build_ui()
        self._emit_banner()
    ...
    def _build_ui(self) -> None:
        self.setStyleSheet(f"""
            QWidget#JaegerChatWindow {{ background-color: {_CANVAS}; }}
            QLabel#HeaderLabel {{
        ...
        self.header = QLabel(f"jaeger · {self._agent_name} · local")
