...
class AgentSettingsWindow(QWidget):
    ...
    def _library_page(self) -> QWidget:
        from jaeger_ai.characters.character import list_characters
    ...
    def _make_default(self, ch: Any) -> None:
        ...
        from jaeger_ai.characters.character import bind_character
        try:
            root = getattr(self._inst_layout(), "root", None)
            if root is not None:
    ...
    def _save_character(self) -> None:
        from jaeger_ai.characters.character import save_character_profile
        try:
    ...
    def _save_traits(self) -> None:
        from jaeger_ai.characters.character import save_character_traits
