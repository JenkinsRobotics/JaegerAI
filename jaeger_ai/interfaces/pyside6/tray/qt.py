...
class QtTray:
    def __init__(self, ctx: Any) -> None:
        ...
        self._hotkey = None
        try:
            from jaeger_ai.interfaces.pyside6.tray.hotkey import GlobalHotkey
            hk = GlobalHotkey()
    ...
    def _open_settings(self) -> None:
        ...
        from jaeger_ai.interfaces.pyside6.agent_settings.window import make_surface
    ...
    def _show_pill(self) -> None:
        if self._pill is None:
            from jaeger_ai.interfaces.pyside6.pill.qt import Pill
