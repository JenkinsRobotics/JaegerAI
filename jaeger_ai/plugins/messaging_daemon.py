...
`plugins/imessage/`). Run:
    ...
    python -m jaeger_os.plugins.messaging_daemon
    python -m jaeger_os.plugins.messaging_daemon --no-imessage
    python -m jaeger_os.plugins.messaging_daemon --no-discord
