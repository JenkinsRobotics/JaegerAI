...
def list_models() -> dict[str, Any]:
    ...
    from jaeger_ai.core.models.model_resolver import MODEL_REGISTRY, list_registered_models
...
def download_model(name: str) -> dict[str, Any]:
    ...
    from jaeger_ai.core.models.model_resolver import download_model as _download
