...
def build_skill_index_block() -> str:
    ...
    try:
        from jaeger_ai.agent.skill_registry.playbook_skills import build_skill_index
...
def build_board_block(layout: InstanceLayout) -> str:
    ...
    try:
        from jaeger_ai.agent.background.board import board_digest
...
def build_runtime_tail() -> str:
    ...
    try:
        from jaeger_ai.agent.skill_registry.toolset_scoping import _scoping_enabled
