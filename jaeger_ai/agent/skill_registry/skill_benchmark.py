...
from jaeger_ai.agent.skill_registry.skill_package import find_skill_dir
...
def benchmark_skill(layout: Any, skill_name: str) -> dict[str, Any]:
    ...
    try:
        from jaeger_ai.agent.skill_registry.capability_state import record_benchmark_result
