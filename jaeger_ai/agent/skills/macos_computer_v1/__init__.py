...
def register(host: Any) -> None:
    ...
    from jaeger_ai.agent.skills.macos_computer_v1.macos_computer import register as _register
    _register(host)
...
def computer_do(goal: Any) -> dict:
    ...
    from jaeger_ai.agent.skills.macos_computer_v1.macos_computer import computer_do as _impl
    return _impl(goal)


def computer_use(action: str, target: str = "", **kwargs: Any) -> dict:
    """Dispatch ONE action — see ``macos_computer.computer_use``."""
    from jaeger_ai.agent.skills.macos_computer_v1.macos_computer import computer_use as _impl
...
def computer_look(app: str = "", include_screenshot: bool = False) -> dict:
    ...
    from jaeger_ai.agent.skills.macos_computer_v1.macos_computer import computer_look as _impl
