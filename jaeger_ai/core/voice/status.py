"""What speech input and output can actually use on this machine.

Two readers need this: runtime capability truth (what the Entity says it
can do) and the voice client. It lives here so they cannot disagree — the
capability snapshot used to hard-code audio as "not enabled" while Kokoro
and Whisper were installed, cached and working.
