...
from jaeger_ai.core.bench import BenchCase, summarise
from jaeger_ai.core.bench.cases import CASES, UMBRELLA_EQUIVALENTS, all_tags
from jaeger_ai.core.bench.runner import (
    BenchRow,
    _contains_all,
    _contains_any,
    _filter_cases,
...
def test_bench_scope_auto_approves_sandbox_tiers():
    ...
    from jaeger_ai.agent.tools.bench import _bench_permission_scope
...
def test_hermetic_memory_restores_pre_bench_contents(tmp_path):
    ...
    import types
    from jaeger_ai.core.bench.runner import _hermetic_memory
    mem = tmp_path / "memory"
...
def _mk_row(**over):
    from jaeger_ai.core.bench.runner import BenchRow
    base = dict(
...
def test_loop_health_metrics_aggregates_ttft_and_halts():
    from jaeger_ai.core.bench.runner import _loop_health_metrics
    rows = [
...
def test_loop_health_metrics_in_summary():
    from jaeger_ai.core.bench.runner import summarise
...
def test_v12_corpus_additions_present():
    from jaeger_ai.core.bench.cases import BENCHMARK_VERSION, CASES, all_tags
