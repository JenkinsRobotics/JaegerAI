...
from jaeger_ai.core.diagnostics import run_health_checks
from jaeger_ai.core.diagnostics.probe import (
    DEFAULT_CHECKS,
    HealthCheck,
    HealthResult,
    _run_one,
...
def test_check_memory_uses_explicit_submodule_imports():
    ...
    import inspect
    from jaeger_ai.core.diagnostics import probe
...
def test_check_drift_parser_returns_pass_on_canonical_sample():
    ...
    call named ``get_time``."""
    from jaeger_ai.core.diagnostics.probe import _check_drift_parser
...
def test_update_check_reports_available(monkeypatch):
    ...
    from jaeger_ai.core.diagnostics import doctor as D
