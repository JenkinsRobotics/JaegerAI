...
def test_render_produces_markdown_table(fake_repo):
    ...
    assert "# Jaeger AI Benchmark Leaderboard" in md
...
def test_history_write_persists_history_md(fake_repo, capsys):
    ...
    assert "# Jaeger AI Benchmark Leaderboard" in written.read_text(encoding="utf-8")
...
def test_write_history_md_silent_helper(fake_repo, capsys):
    ...
    assert "# Jaeger AI Benchmark Leaderboard" in out_path.read_text(encoding="utf-8")
