...
from jaeger_ai.interfaces.pyside6.rich_tui.window import ChatWindow  # noqa: E402
...
def test_chat_session_routing_and_slash_commands(qapp):
    ...
    from jaeger_ai.core.messages import ChatReply
...
def test_tray_tracks_live_agent_state(qapp):
    ...
    from jaeger_ai.interfaces.pyside6.tray.qt import QtTray
