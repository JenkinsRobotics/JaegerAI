...
def test_operator_recovery_finds_exact_store_and_allows_next_turn(tmp_path, monkeypatch):
    ...
    from jaeger_ai.contract.frameworks import BackendCapabilities, BackendRegistration
    ...
    registration = BackendRegistration(
        ...
        BackendCapabilities(True, True, True, True, True),
    )
    monkeypatch.setattr(recovery, "backend", lambda runtime: registration)
