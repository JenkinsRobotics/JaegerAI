...
def test_warm_plugins_async_returns_immediately_and_flips_done(monkeypatch):
    ...
    monkeypatch.setattr(
        "jaeger_ai.core.runtime.readiness.warm_all", _slow_warm_all,
    )
    monkeypatch.setattr(
        "jaeger_ai.core.runtime.readiness.summarize", lambda statuses: "",
    )
    monkeypatch.setattr(
        "jaeger_ai.core.runtime.readiness.all_go", lambda statuses: True,
    )
...
def test_warm_plugins_async_surfaces_a_failed_background_warm(monkeypatch):
    ...
    monkeypatch.setattr(
        "jaeger_ai.core.runtime.readiness.warm_all", _raising_warm_all,
    )
