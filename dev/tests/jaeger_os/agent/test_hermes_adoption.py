...
def test_rate_limit_retries_same_adapter_then_succeeds(monkeypatch):
    import jaeger_os.agent.loop.jaeger_agent as loop_mod
...
def test_loop_passes_on_delta_only_when_listener_installed():
    from jaeger_os.agent import AgentCallbacks
...
def test_aggregator_emits_text_deltas():
    import threading
    from jaeger_os.agent.adapters.openai import _aggregate_chat_stream
