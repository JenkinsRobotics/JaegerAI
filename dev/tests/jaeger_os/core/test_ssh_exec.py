...
from jaeger_os.agent.tools import remote as remote_tool
from jaeger_os.agent.tools.remote import ssh_exec
...
def test_interrupt_surfaces_with_exit_code_130(monkeypatch):
    ...
    from jaeger_os.core.runtime.tool_interrupt import ToolInterrupted
