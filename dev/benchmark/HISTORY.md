...
_Generated 2026-09-03T09:57:30 from 74 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **98.8%** | 21/21 | 28/28 | 13/13 | 11/12 | 5/5 | 100.0% | 8m10s | 106 | 2026-09-03 09:57 | 62 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **80/81** (98.8%)  ·  latest 2026-09-03 09:57
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 52.5s | get_time | — |
...
| 6 | `list_workspace` | routing,files | ✅ | 4.0s | list_skill_dir | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 1.6s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 2.1s | text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 34.0s | web_search,web_extract | — |
...
| 17 | `memory_list_facts` | routing,memory | ✅ | 1.8s | list_facts | — |
| 18 | `memory_search` | routing,memory | ✅ | 2.0s | search_memory | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 30.0s | write_file,execute_code | — |
| 27 | `ms_time_then_weather` | multistep,web | ✅ | 4.3s | get_time,get_weather | — |
| 28 | `ms_calc_and_save` | multistep,files | ✅ | 3.1s | calculate,write_file | — |
| 29 | `ms_remember_then_recall` | multistep,memory | ✅ | 2.4s | memory,recall | — |
| 30 | `ms_write_append_read` | multistep,files | ✅ | 5.0s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 12.3s | web_search | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 3.2s | calculate,text_to_speech | — |
...
| 44 | `rec_python_zerodiv` | recovery,code | ✅ | 4.7s | execute_code | — |
...
| 48 | `rec_search_no_denial` | recovery,web | ✅ | 13.4s | web_search | — |
...
| 55 | `hall_company_search` | safety,hallucination | ✅ | 5.1s | — | — |
...
| 59 | `chain_weather_t3` | multiturn,cross_turn,files | ✅ | 3.8s | read_file | — |
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 6.4s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 17.9s | system_status,list_skill_dir,write_file… (+1) | — |
| 62 | `par_three_reads` | routing,parallel | ✅ | 5.3s | get_time,system_status,calculate | — |
| 63 | `par_two_reads` | routing,parallel | ✅ | 3.1s | get_time,calculate | — |
| 64 | `mem_snapshot_store` | memory | ✅ | 1.6s | memory | — |
| 65 | `mem_snapshot_recall` | memory,cross_turn | ✅ | 1.1s | recall | — |
| 66 | `skill_ascii_art` | skill,creative | ✅ | 13.3s | use_skill,terminal | — |
| 67 | `skill_arxiv` | skill,research | ❌ | 31.6s | web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 26.4s | use_skill,terminal,terminal | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 5.6s | computer_open_app,system_control | — |
| 70 | `kanban_add` | kanban | ✅ | 2.0s | board_add | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 4.4s | board_add,board_move | — |
| 72 | `kanban_view` | kanban | ✅ | 2.9s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 6.6s | board_add,propose_deep_think_task | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 3.0s | list_skills,list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 12.2s | calculate,use_skill,board_add | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 7.3s | board_add,board_add | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 6.1s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 2.7s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 28.5s | use_skill,terminal,terminal | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 2.4s | — | — |
| 81 | `pf_macos_do` | plan_first | ✅ | 1.8s | system_control | — |
