...
_Generated 2026-07-12T16:34:56 from 56 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **97.5%** | 21/21 | 27/28 | 13/13 | 12/12 | 4/5 | 100.0% | 9m12s | 148 | 2026-07-12 16:34 | 44 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **79/81** (97.5%)  ·  latest 2026-07-12 16:34
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 41.1s | get_time | — |
...
| 9 | `web_news` | routing,web | ✅ | 18.9s | web_search,web_extract | — |
...
| 20 | `help_overview` | routing | ✅ | 9.4s | help_me | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 9.2s | write_file,execute_code | — |
...
| 30 | `ms_write_append_read` | multistep,files | ✅ | 4.5s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 5.0s | web_search | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 2.6s | calculate,text_to_speech | — |
| 33 | `ms_three_facts_summary` | multistep,memory | ✅ | 5.5s | memory,memory,memory… (+1) | — |
...
| 43 | `rec_python_syntax` | recovery,code | ✅ | 3.3s | execute_code | — |
| 44 | `rec_python_zerodiv` | recovery,code | ✅ | 4.1s | execute_code | — |
...
| 62 | `par_three_reads` | routing,parallel | ✅ | 6.2s | get_time,system_status,calculate | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 14.4s | use_skill,terminal,terminal | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 32.9s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 76.7s | use_skill,terminal,terminal | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 34.0s | use_skill,computer_do,computer_open_app… (+5) | — |
| 70 | `kanban_add` | kanban | ✅ | 1.9s | board_add | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 3.3s | board_add,board_move | — |
| 72 | `kanban_view` | kanban | ✅ | 3.2s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 5.4s | board_add,propose_deep_think_task | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 4.7s | list_skills,list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 10.5s | calculate,use_skill,board_add | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 3.7s | board_add | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 4.4s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 2.4s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 33.3s | use_skill,terminal,terminal… (+1) | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 26.0s | — | — |
| 81 | `pf_macos_do` | plan_first | ✅ | 30.7s | use_skill,computer_do,computer_open_app… (+3) | — |
...
|---|---|---|---:|---:|---:|---:|---:|---|
| 1 | 2026-07-12 16:34 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.54 | 32.92 | 22.4 | 81 | flat |
| 2 | 2026-07-04 14:31 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.77 | 26.40 | 17.0 | 81 | flat |
| 3 | 2026-07-04 13:37 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.79 | 25.32 | 16.7 | 81 | flat |
| 4 | 2026-07-12 15:01 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.89 | 33.84 | 15.8 | 81 | flat |
| 5 | 2026-07-05 19:54 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.96 | 21.12 | 19.8 | 81 | flat |
| 6 | 2026-07-05 18:27 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.99 | 19.09 | 19.8 | 81 | flat |
| 7 | 2026-07-05 14:47 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 3.06 | 19.59 | 18.9 | 81 | flat |
| 8 | 2026-07-05 13:53 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 3.12 | 23.95 | 21.1 | 81 | flat |
| 9 | 2026-07-06 09:07 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 3.23 | 19.72 | 16.6 | 81 | flat |
| 10 | 2026-07-03 23:44 | `gemma-4-e4b-it-q4-k-m` | 98.4% | 2.67 | 22.52 | 15.2 | 81 | flat |

## Full chronological log

Every run we have data for (56 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
