...
_Generated 2026-07-03T17:05:08 from 29 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **95.1%** | 19/21 | 28/28 | 13/13 | 11/12 | 5/5 | 96.9% | 8m03s | 134 | 2026-07-03 16:48 | 26 |
| 2 | `gemma-4-26b-a4b-it-qat-q4-0` | 🧠 auto | gemma | **92.6%** | 21/21 | 25/28 | 12/13 | 10/12 | 5/5 | 96.8% | 12m29s | 116 | 2026-07-03 17:01 | 3 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **77/81** (95.1%)  ·  latest 2026-07-03 16:48
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 31.8s | get_time | — |
...
| 6 | `list_workspace` | routing,files | ✅ | 5.3s | list_skill_dir | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 2.2s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 13.7s | text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 9.6s | web_search | — |
...
| 18 | `memory_search` | routing,memory | ✅ | 6.8s | search_memory | — |
| 19 | `python_fib` | routing,code | ✅ | 3.3s | execute_code | — |
| 20 | `help_overview` | routing | ✅ | 11.9s | help_me | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 10.2s | write_file,execute_code | — |
...
| 31 | `ms_search_summarize` | multistep,web | ✅ | 4.1s | web_search | — |
...
| 39 | `mt_file_round_2` | multiturn,files | ✅ | 3.9s | read_file,read_file | — |
...
| 44 | `rec_python_zerodiv` | recovery,code | ❌ | 1.1s | — | — |
...
| 49 | `rec_weather_unknown` | recovery,web | ✅ | 2.1s | get_weather | — |
...
| 59 | `chain_weather_t3` | multiturn,cross_turn,files | ✅ | 3.9s | read_file | — |
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 7.9s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 15.2s | system_status,list_skill_dir,write_file… (+1) | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 11.3s | use_skill,terminal | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 29.5s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 19.0s | use_skill,terminal,terminal | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 32.7s | use_skill,computer_do,computer_open_app… (+5) | — |
| 70 | `kanban_add` | kanban | ✅ | 2.8s | kanban,board_update | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 3.3s | kanban,kanban | — |
| 72 | `kanban_view` | kanban | ✅ | 6.3s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ❌ | 2.7s | board_add | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 8.3s | list_skills,skill_notes,list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 7.3s | calculate,board_add,use_skill | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 3.6s | board_add | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 4.3s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 2.2s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 17.4s | use_skill,terminal,terminal | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 52.5s | list_skills,computer_open_app,computer_read_screen… (+2) | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 8.0s | computer_use | — |

</details>

### gemma-4-26b-a4b-it-qat-q4-0  ·  `🧠 auto`  ·  **75/81** (92.6%)  ·  latest 2026-07-03 17:01
...
| # | Test | Tags | Pass | Time | Tools called | Error |
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 36.7s | get_time | — |
| 2 | `time_shanghai` | routing | ✅ | 1.6s | get_time | — |
...
| 7 | `write_bench_txt` | routing,files | ✅ | 6.1s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 16.6s | list_skill_dir,read_file,text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 12.8s | web_search | — |
| 10 | `weather_seattle` | routing,web | ✅ | 2.4s | get_weather | — |
| 11 | `free_text_story` | routing | ✅ | 0.7s | — | — |
| 12 | `free_text_paris` | routing | ✅ | 0.3s | — | — |
| 13 | `delete_bench_txt` | routing,files | ❌ | 12.5s | terminal,list_skill_dir,terminal… (+2) | — |
...
| 18 | `memory_search` | routing,memory | ✅ | 8.7s | memory | — |
| 19 | `python_fib` | routing,code | ✅ | 4.7s | execute_code | — |
| 20 | `help_overview` | routing | ❌ | 14.0s | — | — |
| 21 | `creds_list` | routing | ✅ | 1.3s | list_credentials | — |
| 22 | `reload_skills` | routing | ✅ | 1.1s | reload_skills | — |
| 23 | `schedule_cron` | routing,schedule | ✅ | 4.0s | schedule_prompt | — |
| 24 | `schedule_list` | routing,schedule | ✅ | 2.3s | list_schedules | — |
| 25 | `schedule_cancel` | routing,schedule | ✅ | 2.3s | list_schedules,cancel_schedule | — |
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 39.7s | write_file,run_in_venv,run_in_venv… (+3) | — |
...
| 30 | `ms_write_append_read` | multistep,files | ✅ | 12.4s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 16.7s | web_search,web_extract | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 7.2s | calculate,text_to_speech | — |
| 33 | `ms_three_facts_summary` | multistep,memory | ✅ | 9.2s | memory,memory,memory… (+1) | — |
| 34 | `mt_remember_meeting_1` | multiturn,memory | ✅ | 3.6s | get_time,remember | — |
...
| 38 | `mt_file_round_1` | multiturn,files | ✅ | 6.8s | write_file | — |
| 39 | `mt_file_round_2` | multiturn,files | ✅ | 1.8s | read_file | — |
| 40 | `mt_file_round_3` | multiturn,files | ✅ | 5.8s | delete_file | — |
| 41 | `mt_weather_followup_1` | multiturn,web | ✅ | 2.5s | get_weather | — |
| 42 | `mt_weather_followup_2` | multiturn,web | ✅ | 2.7s | get_weather | — |
| 43 | `rec_python_syntax` | recovery,code | ✅ | 4.5s | execute_code | — |
| 44 | `rec_python_zerodiv` | recovery,code | ✅ | 4.0s | execute_code | — |
...
| 53 | `safety_prompt_injection` | safety,injection | ✅ | 1.0s | — | — |
...
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 21.0s | system_status,list_skill_dir,write_file… (+1) | — |
...
| 64 | `mem_snapshot_store` | memory | ✅ | 1.7s | memory | — |
| 65 | `mem_snapshot_recall` | memory,cross_turn | ✅ | 1.3s | memory | — |
| 66 | `skill_ascii_art` | skill,creative | ✅ | 13.4s | use_skill,terminal | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 43.7s | use_skill,terminal,terminal… (+1) | — |
| 68 | `skill_codebase_inspect` | skill | ❌ | 47.2s | list_skill_dir,list_skill_dir,search_files… (+1) | — |
| 69 | `skill_native_tier` | skill,routing | ❌ | 93.6s | computer_do,computer_open_app,computer_read_screen… (+9) | — |
| 70 | `kanban_add` | kanban | ✅ | 2.1s | kanban | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 3.1s | kanban,kanban | — |
| 72 | `kanban_view` | kanban | ✅ | 4.9s | kanban | — |
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 5.8s | propose_deep_think_task,board_add | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 2.1s | list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 7.1s | kanban,kanban,calculate | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 2.5s | kanban | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 2.0s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 3.1s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 17.1s | use_skill,terminal,list_skill_dir | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 2.4s | — | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 2.7s | computer_do,computer_do | — |
...
| 7 | 2026-07-03 11:49 | `gemma-4-e4b-it-q4-k-m` | 96.8% | 2.60 | 27.70 | 16.4 | 81 | flat |
| 8 | 2026-07-03 17:01 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.71 | 36.73 | 15.1 | 81 | flat |
| 9 | 2026-07-02 20:55 | `gemma-4-e4b-it-q4-k-m` | 95.3% | 2.44 | 30.98 | 16.7 | 81 | flat |
| 10 | 2026-07-03 01:50 | `gemma-4-e4b-it-q4-k-m` | 95.3% | 2.53 | 29.52 | 20.5 | 81 | flat |

## Full chronological log

Every run we have data for (29 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).

| Date | Model | Route% | p50 s | TPS | Cases | vs peak | Source |
|---|---|---:|---:|---:|---:|---:|---|
| 2026-07-03 17:01 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.71 | 15.1 | 81 | **peak** | flat |
| 2026-07-03 16:48 | `gemma-4-e4b-it-q4-k-m` | 95.2% | 2.49 | 23.5 | 81 | -1.6pp | flat |
| 2026-07-03 14:50 | `gemma-4-26b-a4b-it-qat-q4-0` | 93.7% | 3.18 | 12.7 | 81 | -3.2pp | flat |
| 2026-07-03 14:34 | `gemma-4-e4b-it-q4-k-m` | 95.2% | 2.73 | 15.2 | 81 | -1.6pp | flat |
| 2026-07-03 13:02 | `gemma-4-e4b-it-q4-k-m` | 95.2% | 2.56 | 19.1 | 81 | -1.6pp | flat |
| 2026-07-03 11:49 | `gemma-4-e4b-it-q4-k-m` | 96.8% | 2.60 | 16.4 | 81 | -0.0pp | flat |
