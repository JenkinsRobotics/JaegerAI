...
_Generated 2026-07-03T11:49:45 from 24 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **95.1%** | 20/21 | 28/28 | 12/13 | 11/12 | 5/5 | 96.9% | 10m18s | 121 | 2026-07-03 11:49 | 23 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **77/81** (95.1%)  ·  latest 2026-07-03 11:49
...
| 8 | `speak_file` | routing,audio | ✅ | 14.5s | text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 10.1s | web_search | — |
...
| 20 | `help_overview` | routing | ✅ | 12.1s | help_me | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 10.9s | write_file,execute_code | — |
...
| 31 | `ms_search_summarize` | multistep,web | ✅ | 4.3s | web_search | — |
...
| 44 | `rec_python_zerodiv` | recovery,code | ✅ | 9.1s | execute_code | — |
...
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 8.1s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 15.6s | system_status,list_skill_dir,write_file… (+2) | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 27.7s | use_skill,execute_code | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 39.9s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 15.9s | use_skill | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 87.2s | use_skill,computer_open_app,computer_read_screen… (+6) | — |
| 70 | `kanban_add` | kanban | ✅ | 3.0s | kanban,board_update | — |
...
| 74 | `selfimprove_curate` | self_improve | ✅ | 23.1s | skill,skill_notes,skill_notes | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 6.9s | calculate,use_skill,board_add | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 3.6s | board_add | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 5.0s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 3.0s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 23.4s | use_skill,web_search | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 67.6s | use_skill,computer_open_app,computer_read_screen… (+3) | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 8.0s | computer_do | — |
...
Every run we have data for (24 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
