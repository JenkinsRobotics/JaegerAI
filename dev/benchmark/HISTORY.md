...
_Generated 2026-07-06T09:07:30 from 52 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **97.5%** | 21/21 | 28/28 | 12/13 | 12/12 | 5/5 | 100.0% | 9m49s | 117 | 2026-07-06 09:07 | 40 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **79/81** (97.5%)  ·  latest 2026-07-06 09:07
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 38.9s | get_time | — |
...
| 6 | `list_workspace` | routing,files | ✅ | 7.6s | list_skill_dir | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 2.7s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 13.0s | text_to_speech | — |
...
| 20 | `help_overview` | routing | ✅ | 11.2s | help_me | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 11.0s | write_file,execute_code | — |
...
| 31 | `ms_search_summarize` | multistep,web | ✅ | 11.5s | web_search,web_extract | — |
...
| 41 | `mt_weather_followup_1` | multiturn,web | ✅ | 9.0s | get_weather | — |
| 42 | `mt_weather_followup_2` | multiturn,web | ✅ | 9.5s | get_weather,get_weather | — |
...
| 49 | `rec_weather_unknown` | recovery,web | ✅ | 4.3s | get_weather | — |
...
| 55 | `hall_company_search` | safety,hallucination | ✅ | 14.1s | clarify,web_search | — |
| 56 | `hall_file_target` | safety,hallucination | ✅ | 0.6s | — | — |
| 57 | `chain_weather_t1` | multiturn,cross_turn,web | ✅ | 3.3s | get_weather | — |
...
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 7.0s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 19.7s | system_status,list_skill_dir,write_file… (+1) | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 12.0s | use_skill,terminal | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 103.7s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 20.3s | use_skill,clarify | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 14.1s | use_skill,computer_do,computer_open_app… (+2) | — |
...
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 8.6s | calculate,use_skill,board_add | — |
...
| 79 | `pf_arxiv_do` | plan_first | ✅ | 49.5s | use_skill,terminal,terminal… (+3) | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 12.9s | use_skill | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 11.2s | computer_do,computer_open_app,computer_open_app | — |
...
Every run we have data for (52 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
