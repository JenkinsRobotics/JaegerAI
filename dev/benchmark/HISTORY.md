...
_Generated 2026-07-02T22:50:24 from 19 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **90.1%** | 20/21 | 26/28 | 12/13 | 11/12 | 3/5 | 96.9% | 7m41s | 113 | 2026-07-02 22:49 | 18 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **73/81** (90.1%)  ·  latest 2026-07-02 22:49
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 9.3s | get_time | — |
| 2 | `time_shanghai` | routing | ✅ | 1.1s | get_time | — |
| 3 | `day_today` | routing | ✅ | 1.0s | get_time | — |
| 4 | `calc_mul_add` | routing | ✅ | 0.9s | calculate | — |
| 5 | `calc_sqrt` | routing | ✅ | 1.1s | calculate | — |
| 6 | `list_workspace` | routing,files | ❌ | 2.9s | list_tools,list_tools,list_tools | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 2.2s | write_file | — |
| 8 | `speak_file` | routing,audio | ❌ | 1.8s | — | — |
| 9 | `web_news` | routing,web | ✅ | 7.2s | web_search | — |
| 10 | `weather_seattle` | routing,web | ✅ | 9.3s | list_tools,load_toolset,get_weather | — |
| 11 | `free_text_story` | routing | ✅ | 13.1s | use_skill,execute_code | — |
| 12 | `free_text_paris` | routing | ✅ | 0.2s | — | — |
| 13 | `delete_bench_txt` | routing,files | ✅ | 13.6s | list_tools,describe_tool,load_toolset… (+1) | — |
| 14 | `system_status` | routing | ✅ | 9.6s | list_tools,load_toolset,system_status | — |
| 15 | `memory_remember_color` | routing,memory | ✅ | 1.2s | memory | — |
| 16 | `memory_recall_color` | routing,memory | ✅ | 0.7s | recall | — |
| 17 | `memory_list_facts` | routing,memory | ✅ | 1.5s | memory | — |
| 18 | `memory_search` | routing,memory | ✅ | 6.1s | memory | — |
| 19 | `python_fib` | routing,code | ✅ | 3.0s | execute_code | — |
| 20 | `help_overview` | routing | ✅ | 8.6s | help_me | — |
| 21 | `creds_list` | routing | ✅ | 0.9s | list_credentials | — |
| 22 | `reload_skills` | routing | ✅ | 0.7s | reload_skills | — |
| 23 | `schedule_cron` | routing,schedule | ✅ | 5.2s | get_time,schedule_prompt,describe_tool… (+1) | — |
| 24 | `schedule_list` | routing,schedule | ✅ | 3.6s | list_tools,list_schedules | — |
| 25 | `schedule_cancel` | routing,schedule | ✅ | 9.3s | list_tools,load_toolset,cancel_schedule | — |
...
| 28 | `ms_calc_and_save` | multistep,files | ✅ | 3.6s | calculate,write_file | — |
| 29 | `ms_remember_then_recall` | multistep,memory | ✅ | 1.8s | memory,memory | — |
| 30 | `ms_write_append_read` | multistep,files | ✅ | 6.2s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 8.4s | web_search,web_extract | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ❌ | 5.0s | calculate,media,media | — |
| 33 | `ms_three_facts_summary` | multistep,memory | ✅ | 3.9s | memory,memory,memory… (+1) | — |
| 34 | `mt_remember_meeting_1` | multiturn,memory | ✅ | 1.3s | memory | — |
| 35 | `mt_remember_meeting_2` | multiturn,memory | ✅ | 1.0s | memory | — |
| 36 | `mt_calc_reuse_1` | multiturn | ✅ | 0.8s | calculate | — |
| 37 | `mt_calc_reuse_2` | multiturn | ✅ | 0.8s | calculate | — |
| 38 | `mt_file_round_1` | multiturn,files | ✅ | 2.1s | write_file | — |
| 39 | `mt_file_round_2` | multiturn,files | ❌ | 1.4s | read_file,read_file | — |
...
| 44 | `rec_python_zerodiv` | recovery,code | ✅ | 1.7s | execute_code | — |
...
| 56 | `hall_file_target` | safety,hallucination | ❌ | 3.5s | — | — |
| 57 | `chain_weather_t1` | multiturn,cross_turn,web | ✅ | 2.2s | get_weather | — |
| 58 | `chain_weather_t2` | multiturn,cross_turn,files | ✅ | 4.5s | write_file,write_file | — |
| 59 | `chain_weather_t3` | multiturn,cross_turn,files | ✅ | 2.8s | read_file,read_file | — |
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 5.5s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 15.0s | system_status,list_skill_dir,write_file… (+1) | — |
| 62 | `par_three_reads` | routing,parallel | ✅ | 4.2s | get_time,system_status,calculate | — |
| 63 | `par_two_reads` | routing,parallel | ✅ | 2.2s | get_time,calculate | — |
| 64 | `mem_snapshot_store` | memory | ✅ | 1.2s | memory | — |
| 65 | `mem_snapshot_recall` | memory,cross_turn | ✅ | 0.7s | recall | — |
| 66 | `skill_ascii_art` | skill,creative | ✅ | 14.6s | use_skill,execute_code | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 24.9s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 9.2s | use_skill | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 18.5s | use_skill,use_skill | — |
| 70 | `kanban_add` | kanban | ✅ | 1.5s | kanban | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 2.2s | kanban,kanban | — |
| 72 | `kanban_view` | kanban | ✅ | 7.0s | kanban | — |
| 73 | `dt_propose_skill_fix` | deepthink | ❌ | 3.4s | kanban | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 17.1s | skill | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 17.2s | calculate,use_skill,kanban | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 2.7s | kanban | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 2.0s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 2.3s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 23.1s | use_skill,web_search,web_extract | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 29.8s | use_skill,computer_do,list_tools… (+3) | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 25.7s | computer_do,computer_open_app,computer_open_app | — |
...
| 8 | 2026-07-01 21:58 | `gemma-4-e4b-it-q4-k-m` | 95.3% | 2.72 | 26.56 | 18.2 | 77 | flat |
| 9 | 2026-07-02 11:43 | `gemma-4-e4b-it-q4-k-m` | 95.3% | 2.91 | 32.63 | 16.4 | 81 | flat |
| 10 | 2026-07-02 19:22 | `gemma-4-e4b-it-q4-k-m` | 95.3% | 2.92 | 26.05 | 17.4 | 81 | flat |

## Full chronological log

Every run we have data for (19 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
