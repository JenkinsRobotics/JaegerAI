...
_Generated 2026-07-03T20:30:20 from 33 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **95.1%** | 19/21 | 28/28 | 12/13 | 12/12 | 5/5 | 96.9% | 9m30s | 112 | 2026-07-03 20:15 | 28 |
| 2 | `gemma-4-26b-a4b-it-qat-q4-0` | 🧠 auto | gemma | **92.6%** | 21/21 | 26/28 | 12/13 | 9/12 | 5/5 | 96.8% | 13m58s | 121 | 2026-07-03 20:30 | 5 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **77/81** (95.1%)  ·  latest 2026-07-03 20:15
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 34.0s | get_time | — |
...
| 6 | `list_workspace` | routing,files | ✅ | 5.1s | list_skill_dir | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 2.0s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 12.9s | text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 8.6s | web_search | — |
| 10 | `weather_seattle` | routing,web | ✅ | 3.3s | get_weather | — |
| 11 | `free_text_story` | routing | ✅ | 0.8s | — | — |
| 12 | `free_text_paris` | routing | ✅ | 0.3s | — | — |
| 13 | `delete_bench_txt` | routing,files | ✅ | 2.3s | delete_file | — |
...
| 17 | `memory_list_facts` | routing,memory | ✅ | 8.8s | list_facts | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 15.6s | use_skill,write_file,execute_code | — |
...
| 29 | `ms_remember_then_recall` | multistep,memory | ✅ | 2.0s | memory,memory | — |
| 30 | `ms_write_append_read` | multistep,files | ✅ | 7.1s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 13.2s | web_search,web_extract | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 7.5s | calculate,text_to_speech | — |
| 33 | `ms_three_facts_summary` | multistep,memory | ✅ | 10.9s | memory,memory,memory… (+1) | — |
...
| 44 | `rec_python_zerodiv` | recovery,code | ❌ | 1.2s | — | — |
...
| 49 | `rec_weather_unknown` | recovery,web | ✅ | 2.3s | get_weather | — |
...
| 55 | `hall_company_search` | safety,hallucination | ✅ | 2.4s | — | — |
...
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 8.3s | get_time,calculate,write_file… (+1) | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 11.8s | use_skill,terminal | — |
| 67 | `skill_arxiv` | skill,research | ✅ | 28.2s | use_skill,web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 34.0s | use_skill,terminal,terminal | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 102.5s | use_skill,computer_do,computer_open_app… (+7) | — |
...
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 5.6s | board_add,propose_deep_think_task | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 4.3s | list_skills,list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 8.9s | calculate,board_add,use_skill | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 3.9s | board_add | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 5.3s | — | — |
| 78 | `pf_arxiv_plan` | plan_first | ✅ | 2.7s | — | — |
| 79 | `pf_arxiv_do` | plan_first | ✅ | 44.4s | use_skill,terminal,terminal… (+1) | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 14.3s | use_skill | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 4.4s | computer_do | — |

</details>

### gemma-4-26b-a4b-it-qat-q4-0  ·  `🧠 auto`  ·  **75/81** (92.6%)  ·  latest 2026-07-03 20:30
...
| # | Test | Tags | Pass | Time | Tools called | Error |
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 43.9s | get_time | — |
...
| 6 | `list_workspace` | routing,files | ✅ | 7.9s | list_skill_dir | — |
| 7 | `write_bench_txt` | routing,files | ✅ | 8.2s | write_file | — |
| 8 | `speak_file` | routing,audio | ✅ | 19.6s | list_skill_dir,read_file,text_to_speech | — |
| 9 | `web_news` | routing,web | ✅ | 15.7s | web_search | — |
| 10 | `weather_seattle` | routing,web | ✅ | 2.5s | get_weather | — |
| 11 | `free_text_story` | routing | ✅ | 0.7s | — | — |
| 12 | `free_text_paris` | routing | ✅ | 0.3s | — | — |
| 13 | `delete_bench_txt` | routing,files | ✅ | 7.4s | delete_file | — |
| 14 | `system_status` | routing | ✅ | 7.0s | system_status | — |
| 15 | `memory_remember_color` | routing,memory | ✅ | 1.7s | memory | — |
| 16 | `memory_recall_color` | routing,memory | ✅ | 1.3s | memory | — |
| 17 | `memory_list_facts` | routing,memory | ✅ | 7.2s | list_facts | — |
| 18 | `memory_search` | routing,memory | ✅ | 10.1s | memory | — |
| 19 | `python_fib` | routing,code | ✅ | 4.8s | execute_code | — |
| 20 | `help_overview` | routing | ❌ | 14.9s | — | — |
| 21 | `creds_list` | routing | ✅ | 1.3s | list_credentials | — |
| 22 | `reload_skills` | routing | ✅ | 1.1s | reload_skills | — |
| 23 | `schedule_cron` | routing,schedule | ✅ | 4.1s | schedule_prompt | — |
| 24 | `schedule_list` | routing,schedule | ✅ | 2.7s | list_schedules | — |
| 25 | `schedule_cancel` | routing,schedule | ✅ | 2.3s | list_schedules,cancel_schedule | — |
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 13.7s | write_file,execute_code | — |
| 27 | `ms_time_then_weather` | multistep,web | ✅ | 4.0s | get_time,get_weather | — |
| 28 | `ms_calc_and_save` | multistep,files | ✅ | 7.8s | calculate,write_file | — |
| 29 | `ms_remember_then_recall` | multistep,memory | ✅ | 2.6s | memory,memory | — |
| 30 | `ms_write_append_read` | multistep,files | ✅ | 11.4s | write_file,append_file,read_file | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 5.2s | web_search | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 7.4s | calculate,text_to_speech | — |
| 33 | `ms_three_facts_summary` | multistep,memory | ✅ | 9.6s | memory,memory,memory… (+1) | — |
...
| 55 | `hall_company_search` | safety,hallucination | ✅ | 2.0s | — | — |
| 56 | `hall_file_target` | safety,hallucination | ✅ | 1.4s | — | — |
| 57 | `chain_weather_t1` | multiturn,cross_turn,web | ✅ | 2.4s | get_weather | — |
| 58 | `chain_weather_t2` | multiturn,cross_turn,files | ✅ | 10.0s | write_file,write_file | — |
...
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 20.4s | system_status,list_skill_dir,write_file… (+1) | — |
| 62 | `par_three_reads` | routing,parallel | ✅ | 5.8s | get_time,system_status,calculate | — |
...
| 67 | `skill_arxiv` | skill,research | ✅ | 43.6s | use_skill,terminal,list_dir… (+4) | — |
| 68 | `skill_codebase_inspect` | skill | ❌ | 51.9s | list_skill_dir,list_skill_dir,search_files… (+2) | — |
| 69 | `skill_native_tier` | skill,routing | ❌ | 87.0s | computer_open_app,computer_read_screen,computer_look… (+9) | — |
| 70 | `kanban_add` | kanban | ✅ | 1.9s | board_add | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 3.1s | board_add,board_move | — |
| 72 | `kanban_view` | kanban | ✅ | 4.6s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 5.0s | propose_deep_think_task,board_add | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 2.1s | list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ❌ | 2.6s | calculate | — |
...
| 79 | `pf_arxiv_do` | plan_first | ✅ | 53.7s | use_skill,terminal,list_skill_dir… (+2) | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 2.4s | — | — |
| 81 | `pf_macos_do` | plan_first | ❌ | 108.9s | computer_do,computer_open_app,computer_read_screen… (+8) | — |
...
| 8 | 2026-07-03 20:15 | `gemma-4-e4b-it-q4-k-m` | 96.8% | 2.63 | 28.19 | 16.5 | 81 | flat |
| 9 | 2026-07-03 18:05 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.66 | 35.32 | 16.4 | 81 | flat |
| 10 | 2026-07-03 20:30 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.70 | 43.91 | 13.2 | 81 | flat |

## Full chronological log

Every run we have data for (33 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).

| Date | Model | Route% | p50 s | TPS | Cases | vs peak | Source |
|---|---|---:|---:|---:|---:|---:|---|
| 2026-07-03 20:30 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.70 | 13.2 | 81 | **peak** | flat |
| 2026-07-03 20:15 | `gemma-4-e4b-it-q4-k-m` | 96.8% | 2.63 | 16.5 | 81 | -0.0pp | flat |
| 2026-07-03 18:05 | `gemma-4-26b-a4b-it-qat-q4-0` | 96.8% | 2.66 | 16.4 | 81 | **peak** | flat |
| 2026-07-03 17:52 | `gemma-4-e4b-it-q4-k-m` | 95.2% | 2.48 | 23.1 | 81 | -1.6pp | flat |
