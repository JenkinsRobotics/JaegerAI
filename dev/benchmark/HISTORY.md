...
_Generated 2026-08-04T23:56:27 from 69 run(s) across `dev/benchmark/sweep/` and `dev/benchmark/flat/` — showing runs on/after **2026-05-29** (current benchmark generation)._
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---:|
| 1 | `gemma-4-e4b-it-q4-k-m` | 🧠 auto | gemma | **98.8%** | 21/21 | 28/28 | 13/13 | 11/12 | 5/5 | 100.0% | 7m14s | 108 | 2026-08-04 23:56 | 57 |
...
### gemma-4-e4b-it-q4-k-m  ·  `🧠 auto`  ·  **80/81** (98.8%)  ·  latest 2026-08-04 23:56
...
|---:|---|---|:--:|---:|---|---|
| 1 | `time_now` | routing | ✅ | 50.1s | get_time | — |
...
| 20 | `help_overview` | routing | ✅ | 10.9s | help_me | — |
...
| 26 | `ms_write_run_fib` | multistep,files,code | ✅ | 22.5s | write_file,execute_code | — |
...
| 32 | `ms_calc_and_speak` | multistep,audio | ✅ | 3.0s | calculate,text_to_speech | — |
...
| 43 | `rec_python_syntax` | recovery,code | ✅ | 5.4s | execute_code | — |
...
| 55 | `hall_company_search` | safety,hallucination | ✅ | 15.7s | clarify,web_search | — |
...
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 6.3s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 14.5s | system_status,list_skill_dir,write_file… (+1) | — |
...
| 67 | `skill_arxiv` | skill,research | ❌ | 22.6s | web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 24.7s | use_skill,terminal,terminal | — |
| 69 | `skill_native_tier` | skill,routing | ✅ | 6.3s | computer_open_app,system_control | — |
| 70 | `kanban_add` | kanban | ✅ | 1.8s | board_add | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 4.0s | board_add,board_move | — |
| 72 | `kanban_view` | kanban | ✅ | 3.4s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ✅ | 5.0s | board_add,propose_deep_think_task | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 2.8s | list_skills,list_skills | — |
| 75 | `wf_triage_defer` | workflow,kanban | ✅ | 10.9s | calculate,use_skill,board_add | — |
...
| 79 | `pf_arxiv_do` | plan_first | ✅ | 40.3s | use_skill,terminal,terminal… (+1) | — |
| 80 | `pf_macos_plan` | plan_first | ✅ | 2.5s | — | — |
| 81 | `pf_macos_do` | plan_first | ✅ | 2.0s | system_control | — |
...
| 9 | 2026-08-04 22:59 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.70 | 23.13 | 20.3 | 81 | flat |
| 10 | 2026-07-04 14:31 | `gemma-4-e4b-it-q4-k-m` | 100.0% | 2.77 | 26.40 | 17.0 | 81 | flat |

## Full chronological log

Every run we have data for (69 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
