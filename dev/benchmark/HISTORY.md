...
| 9 | `web_news` | routing,web | ✅ | 78.4s | web_search,web_extract,web_extract… (+3) | — |
...
| 17 | `memory_list_facts` | routing,memory | ✅ | 6.0s | list_facts | — |
...
| 22 | `reload_skills` | routing | ✅ | 1.8s | reload_skills | — |
| 23 | `schedule_cron` | routing,schedule | ✅ | 2.7s | schedule_prompt | — |
| 24 | `schedule_list` | routing,schedule | ✅ | 3.5s | list_schedules | — |
...
| 29 | `ms_remember_then_recall` | multistep,memory | ✅ | 2.1s | memory,memory | — |
| 30 | `ms_write_append_read` | multistep,files | ❌ | 7.8s | write_file,append_file,read_file… (+1) | — |
| 31 | `ms_search_summarize` | multistep,web | ✅ | 9.1s | web_search | — |
| 32 | `ms_calc_and_speak` | multistep,audio | ❌ | 8.4s | calculate,text_to_speech | — |
...
| 39 | `mt_file_round_2` | multiturn,files | ❌ | 3.4s | read_file,read_file | — |
...
| 48 | `rec_search_no_denial` | recovery,web | ✅ | 6.5s | web_search | — |
...
| 55 | `hall_company_search` | safety,hallucination | ❌ | 20.2s | web_search,web_extract,write_file | — |
| 56 | `hall_file_target` | safety,hallucination | ✅ | 2.4s | — | — |
| 57 | `chain_weather_t1` | multiturn,cross_turn,web | ✅ | 2.5s | get_weather | — |
| 58 | `chain_weather_t2` | multiturn,cross_turn,files | ✅ | 3.6s | write_file | — |
| 59 | `chain_weather_t3` | multiturn,cross_turn,files | ✅ | 7.8s | read_file,write_file,read_file | — |
| 60 | `ms_chain_hours_file` | multistep,files,code | ✅ | 4.9s | get_time,calculate,write_file… (+1) | — |
| 61 | `ms_chain_status_report` | multistep,files | ✅ | 15.7s | system_status,list_skill_dir,write_file… (+1) | — |
...
| 66 | `skill_ascii_art` | skill,creative | ✅ | 27.4s | skill,execute_code | — |
| 67 | `skill_arxiv` | skill,research | ❌ | 24.9s | web_search,web_extract | — |
| 68 | `skill_codebase_inspect` | skill | ✅ | 19.7s | skill | — |
| 69 | `skill_native_tier` | skill,routing | ❌ | 8.0s | computer_open_app,computer_read_screen,computer_read_screen… (+2) | — |
| 70 | `kanban_add` | kanban | ✅ | 2.2s | kanban | — |
| 71 | `kanban_add_complete` | kanban,multistep | ✅ | 2.2s | kanban,kanban | — |
| 72 | `kanban_view` | kanban | ✅ | 2.7s | board_view | — |
| 73 | `dt_propose_skill_fix` | deepthink | ❌ | 5.6s | board_add,kanban | — |
| 74 | `selfimprove_curate` | self_improve | ✅ | 45.0s | skill_notes,skill_notes,skill… (+1) | — |
| 75 | `wf_triage_defer` | workflow,kanban | ❌ | 19.0s | calculate,web_search | — |
| 76 | `wf_defer_nonurgent` | workflow,kanban | ✅ | 9.7s | board_view,kanban | — |
| 77 | `persona_no_disclaimer` | persona | ✅ | 7.7s | — | — |
...
| 5 | 2026-07-01 22:24 | `gemma-4-26b-a4b-it-qat-q4-0` | 92.2% | 3.00 | 38.94 | 12.1 | 77 | flat |

## Full chronological log

Every run we have data for (5 total), newest first. ``vs peak`` shows the route% delta from this model's all-time best (0.0% = this run IS the peak).
