...
def main() -> int:
    ...
    parser.add_argument("--candidate-runner", type=Path, default=Path(__file__).resolve().parents[3] / "jaeger-agent/scripts/benchmark_multimodal_candidate.py")
    ...
    hermetic = build_hermetic_instance(args.source_instance)
