...
| `jaeger_ai/features/webui/service/service.py`, `cli/verbs/webui_verb.py` | `jaeger webui url` discovers the shared container's current address; the standalone URL remains the fallback. |
