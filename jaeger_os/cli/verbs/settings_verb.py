...
from jaeger_os.cli import _common as c
...
def _settings_list(argv: list[str]) -> int:
    ...
    from jaeger_os.core.settings.catalog import catalog
...
def _settings_groups(argv: list[str]) -> int:
    ...
    if layout is None:
        return 1
    from jaeger_os.core.settings.catalog import groups
    print()
...
def _settings_get(argv: list[str]) -> int:
    ...
    if layout is None:
        return 1
    from jaeger_os.core.settings.catalog import describe
