...
3. **Use the Gmail search syntax reference** for complex queries — load it with `skill(action="view", name="google-workspace", file="references/gmail-search-syntax.md")`.
