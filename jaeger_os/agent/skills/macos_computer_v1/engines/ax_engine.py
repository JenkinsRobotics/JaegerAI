...
class AXEngine:
    ...
    def is_available(self) -> tuple[bool, str]:
        ...
        from jaeger_os.agent.skills.macos_computer_v1.engines import _ax_lowlevel
    ...
    def execute(self, action: Action) -> EngineResult:
        from jaeger_os.agent.skills.macos_computer_v1.engines import _ax_lowlevel as ax
