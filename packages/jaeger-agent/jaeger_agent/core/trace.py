"""Core pipeline tracing for the agent turn.
...
class TraceRecorder:
    """Subscribes to ``SYS_TRACE_STEP`` and appends each step to
...
def start_trace_recorder(layout: Any) -> "TraceRecorder | None":
    ...
    with _recorder_lock:
        ...
        try:
            ...
            runtime.get_bus().subscribe(topics.SYS_TRACE_STEP, rec.on_step)
