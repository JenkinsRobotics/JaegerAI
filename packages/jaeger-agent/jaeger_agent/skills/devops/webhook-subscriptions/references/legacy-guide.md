...
description: "Configure and operate webhook subscriptions that trigger agent runs. Use when the user wants an external event or service callback to start a Jaeger workflow."
version: 1.1.0
