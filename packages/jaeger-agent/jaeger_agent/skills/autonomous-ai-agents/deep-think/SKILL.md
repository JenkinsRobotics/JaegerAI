...
board_add(title="…", description="…", priority="low|med|high")   note it on the board
...
3. NOTE it so it isn't lost: `board_add(title="Fix weather skill crash",
   description="malformed-input handling", priority="med")`.
