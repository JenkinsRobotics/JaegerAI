...
description: "Operate the Teams meeting summary pipeline via Hermes CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions. Use when the user explicitly requests this named workflow or its specific output."
version: 1.1.0
