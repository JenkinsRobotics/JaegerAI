...
description: End-to-end pipeline for publication-ready ML/AI papers (NeurIPS, ICML,
  ICLR, ACL, AAAI, COLM). Load this to design/run experiments, draft or revise any
  section, verify citations, self-review, or prep a submission or rebuttal.
metadata:
  jros:
    tags:
    - research
