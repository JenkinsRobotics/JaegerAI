...
requires_tools: [run_shortcut, list_shortcuts, spotlight_search, get_events, create_event,
                 ...
                 copy_file, send_email, list_mailboxes, list_mail, move_mail, batch_move, send_message]
...
metadata:
  jros:
    ...
    category: desktop
    related_skills: [macos-computer-use, file-organization, email-triage, macos-mail-organizer]
---
