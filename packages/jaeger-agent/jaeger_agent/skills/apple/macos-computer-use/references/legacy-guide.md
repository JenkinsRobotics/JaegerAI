...
metadata:
  jros:
    ...
    aliases: [macos_computer, computer_use]
    related_skills: [macos_computer, mac-native, computer_use, browser]
---
...
The requested Mac state is verified (URL open, setting on, AX/look
confirms it). A truthy tool return is not enough.
