...
description: "Debug Hermes TUI slash commands: Python, gateway, Ink UI. Use when the user explicitly requests this named workflow or its specific output."
version: 1.0.0
author: Hermes Agent
license: MIT
...
1. Rebuild the TUI:
   ```bash
   cd <repository-root> && npm --prefix ui-tui run build
   ```
